...
export default function NotFound() {
  return (
    <div style={{ background: '#FFFFFF', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif', padding: '20px', textAlign: 'center' }}>
      ...
      <h1 style={{ fontSize: '72px', fontWeight: '900', color: '#1A1A1A', margin: '0 0 8px', letterSpacing: '-2px' }}>404</h1>
      ...
      <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', justifyContent: 'center' }}>
        <Link href="/" style={{ padding: '12px 28px', background: '#E5B800', borderRadius: '10px', color: '#000', fontWeight: '700', fontSize: '14px', textDecoration: 'none' }}>
          Back to Home
        </Link>
